...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Outfit:wght@600;800&display=swap"
        rel="stylesheet">
                ...
                @foreach ($photos as $photo)
                    <div class="rounded shadow overflow-hidden">
                        <img src="{{ asset('storage/' . $photo->path) }}"
                            class="h-auto max-h-[150px] object-cover rounded" alt="Photo chantier">
                    </div>
                @endforeach
            </div>
        </div>
            ...
            <ul class="space-y-4 text-base">
                ...
                <li class="flex items-center gap-x-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path
                            d="M22 16.92V21a1 1 0 0 1-1.09 1A19.9 19.9 0 0 1 3 5.09 1 1 0 0 1 4 4h4.09a1 1 0 0 1 1 .75c.3 1.23.84 2.41 1.6 3.45a1 1 0 0 1-.25 1.39L9.03 11a16 16 0 0 0 6.94 6.94l1.41-1.41a1 1 0 0 1 1.39-.25c1.04.76 2.22 1.3 3.45 1.6a1 1 0 0 1 .75 1z" />
                    </svg>
                ...
                <li class="flex items-center gap-x-4">
                    ...
                    <span><a href="mailto:contact@pelleteusepapa.fr"
                            class="underline">contact@pelleteusepapa.fr</a></span>
                </li>
    ...
    <section class="py-12 px-4">
        <div class="max-w-lg mx-auto">
            ...
            <form method="POST" action="{{ route('contact.send') }}" class="grid gap-4">
                ...
                <input type="text" name="name" placeholder="Votre nom" class="p-3 rounded bg-[#fff3d4] text-black"
                    required>
                <input type="email" name="email" placeholder="Email" class="p-3 rounded bg-[#fff3d4] text-black"
                    required>
